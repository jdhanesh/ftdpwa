...
self.addEventListener('push', (event) => {
  ...
  var title = 'Mother\'s Day Offer';
  var body = {
    'body': '50% off on bouquet',
    'tag': 'demo',
    'icon': './src/images/icons/apple-touch-icon.png',
    'badge': './src/images/icons/apple-touch-icon.png',
    //Custom actions buttons
    'actions': [
      { 'action': 'yes', 'title': 'I ♥ this Offer!'},
      { 'action': 'no', 'title': 'I don\'t like this Offer'}
    ]
  };
